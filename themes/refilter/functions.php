<?php
/**
 * Refilter Theme functions and definitions.
 *
...
if ( ! function_exists( ' refilter_setup' ) ) :
/**
...
endif; // refilter_setup
add_action( 'after_setup_theme', 'refilter_setup' );
 ...
 */
function refilter_widgets_init() {
...
add_action( 'widgets_init', 'refilter_widgets_init' );

/**
 * Filter the stylesheet_uri to output the minified CSS file.
 */
function refilter_minified_css( $stylesheet_uri, $stylesheet_dir_uri ) {
...
add_filter( 'stylesheet_uri', 'refilter_minified_css', 10, 2 );
...
function refilter_scripts() {
	...
	wp_enqueue_script( 'refilter-shuffle-plugin', get_template_directory_uri() . '/build/js/shuffle-plugin.min.js', array(), '20151244', true );
...
add_action( 'wp_enqueue_scripts', 'refilter_scripts' );
