...
@media only screen and (min-width: 768px) {
		.full-background {
		background: linear-gradient(180deg,rgba(0,0,0,.25) 0,rgba(0,0,0,.25)), url('<?php the_field('landing_blog_post_image_desktop'); ?>') no-repeat center center/cover;
		}
		...
		.landing {
		background: linear-gradient(180deg,rgba(0,0,0,.25) 0,rgba(0,0,0,.25)), url('<?php the_field('landing_blog_post_image_mobile'); ?>') no-repeat center center/cover;
		}	
...
<section class="mobile landing container-fluid">
	<section class="landing-wave"></section>
		<h1><?php the_field('blog_post_title'); ?></h1>
		<h2><?php the_field('blog_post_description'); ?></h2>
</section>		
...
foreach( $wpex_query->posts as $post ) : setup_postdata( $post ); ?>
	<div class="related-posts-image-wrapper">
		...
		<h2 class="related-posts-title"><?php the_title(); ?></h2>
		<div class="read-wrapper"><h2 class="read-more">Read More <i class="fas fa-arrow-right"></i></h2></div>
		</div>
