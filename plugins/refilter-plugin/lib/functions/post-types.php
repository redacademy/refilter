...
function custom_projects_type() {

	$labels = array(
		'name'                  => _x( 'Projects Types', 'Post Type General Name', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Projects Type Description', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail' ),
		'taxonomies'            => array( 'category', 'projects_tag' ),
		'hierarchical'          => false,
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
...
add_action( 'init', 'custom_projects_type', 0 );